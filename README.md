...
const rohith: Developer = {
  ...
  askMeAbout: ["AI/ML", "Full Stack", "System Design", "Medical AI", "LLMs"],
  technologies: {
    frontend: ["React", "Next.js", "Vue", "Flutter"],
    backend: ["Node.js", "Express", "MongoDB", "PostgreSQL"],
    ai_ml: ["TensorFlow", "PyTorch", "Keras", "OpenCV"],
    cloud: ["AWS", "Docker", "Kubernetes", "Kafka"]
  },
  architecture: ["Microservices", "Event-Driven", "Serverless", "Progressive Web Apps"],
  currentFocus: "Building explainable AI systems for healthcare 🏥",
  funFact: "I debug faster than I explain bugs 🐛⚡"
};
```
